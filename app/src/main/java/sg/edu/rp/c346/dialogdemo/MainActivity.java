...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnDemo1, btnDemo2, btnDemo3, btnDemoExercise3, btnDemo4, btnDemo5;
    TextView tvDemo2, tvDemo3, tvDemoExercise3,tvDemo4, tvDemo5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemoExercise3 = findViewById(R.id.buttonDemoExercise3);
        tvDemoExercise3 = findViewById(R.id.textViewExercise3);
...
*/
        ...
        btnDemoExercise3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                // Inflate the input.xml layout file
                LayoutInflater inflater =
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which){
                        ...
                        int sum = num1 + num2;
                        tvDemoExercise3.setText("The sum is " + Integer.toString(sum));
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
                AlertDialog myDialog = myBuilder.create();
        ...
        btnDemo4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog myDateDialog = new DatePickerDialog(MainActivity.this,
                        myDateListener, year, monthOfYear, dayOfMonth);
                myDateDialog.show();
